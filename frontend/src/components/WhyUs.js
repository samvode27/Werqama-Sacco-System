...
function WhyUs() {
  ...
  const icons = [<FaPiggyBank />, <FaHandsHelping />, <FaLock />, <FaChartBar />];
  ...
  return (
    <section className="why-us-section" id="whyus">
      ...
      <Container>
        <div className="section-header mt-3" data-aos="fade-up">
          <h2>{t.whyusTitle}</h2>
          <p>{t.whyusSubtitle}</p>
        </div>
        ...
        >
          ...
          <defs>
            <linearGradient id="gradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#e1da0aff" stopOpacity="0.8" />
              <stop offset="100%" stopColor="#e1da0aff" stopOpacity="0" />
            </linearGradient>
          </defs>
        </svg>
